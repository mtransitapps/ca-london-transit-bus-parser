...
JAVA_FILES_DIR="src/org/mtransit/parser/ca_london_transit_bus";
JAVA_STOPS_FILE="$JAVA_FILES_DIR/Stops.java";
echo ">> Pre Parsing > Set Java stops file...";
> $JAVA_STOPS_FILE; # empty file
echo "package org.mtransit.parser.ca_london_transit_bus;" >> $JAVA_STOPS_FILE;
...
echo "package org.mtransit.parser.ca_london_transit_bus;" >> $JAVA_STOPS_FILE2;
